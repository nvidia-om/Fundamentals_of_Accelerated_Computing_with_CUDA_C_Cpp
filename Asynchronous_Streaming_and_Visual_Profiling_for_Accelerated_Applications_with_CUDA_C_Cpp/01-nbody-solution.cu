...
int main(const int argc, const char** argv) {
   ...
   //printf("Device ID: %d\tNumber of SMs: %d\n", device_id, num_of_sms); // Do not print this as this will cause issue during assesment
  ...
  checkCuda(cudaMemPrefetchAsync(buf, bytes, device_id)); // Prefetching to prevent GPU page faults.  
   ...
   */
    ...
    checkCuda(cudaDeviceSynchronize()); // Wait for integratePosition() to complete before calling bodyForce() in next iteration
